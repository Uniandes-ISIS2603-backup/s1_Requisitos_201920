...
public class IteracionPersistenceTest {
    ...
    public void createTest() {
        ...
        IteracionEntity iteracion = factory.manufacturePojo(IteracionEntity.class);
        
        IteracionEntity result = ip.create(iteracion);
        Assert.assertNotNull(result);
        
        IteracionEntity esperado = em.find(IteracionEntity.class, result.getId());
        Assert.assertEquals(esperado.getNombre(), iteracion.getNombre());
