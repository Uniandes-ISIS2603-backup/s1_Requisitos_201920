...
public class RequisitosCasoDeUsoIT 
{
     private static final String COLLECTION = "RequisitosCasoDeUso-Tests.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_requisitos-api.war")//War del modulo api
                ...
                .addPackage(DesarrolladorDTO.class.getPackage())
                .addPackage(CasoDeUsoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
                .addPackage(CasoDeUsoDetailDTO.class.getPackage())
                .addPackage(RequisitosDTO.class.getPackage())
                .addPackage(RequisitosDetailDTO.class.getPackage())
