...
public class EquipoDesarrolloIT {
    private static final String COLLECTION = "EquipoDesarrollo Test.postman_collection";
    ...
    public void postman() throws IOException {
        ...
        Assert.assertEquals("Error en Proyectos de: " + COLLECTION, desiredResult, tp.getIterations_failed());
